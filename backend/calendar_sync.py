...
# Додавання події
# ====================
def add_event_to_calendar(summary: str, start_time: datetime.datetime, end_time: datetime.datetime, description: str = ""):
    ...
    event = service.events().insert(calendarId=DEFAULT_CALENDAR_ID, body=event).execute()
    print(f"Подія створена: {event.get('htmlLink')}")
    return event
